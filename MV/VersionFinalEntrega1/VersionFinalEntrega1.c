...
void lectura(mv* MV, char* argv[]){
    ...
    //FILE *arch = fopen("C:/Users/Octii/Desktop/Facultad/3erAnio/ArquitecturadeComputadoras/CosasArqui/MV/ArchivosMV/lectura_escritura_decimal_binario41.vmx", "rb");
    if( arch != NULL){
...
char* EscrReg(mv MV, int operando){
    char* nombresRegistros[16] = {"CS", "DS", "", "", "", "IP", "", "", "CC", "AC", "EAL", "EBX", "ECX", "EDX", "EEX", "EFX"};
